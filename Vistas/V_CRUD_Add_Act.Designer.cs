namespace Vistas
{
    partial class V_CRUD_Add_Act
    {
        ...
        private void InitializeComponent()
        {
            ...
            Pnl_Add = new Panel();
            Txt_Desc_Act = new TextBox();
            Txt_Name_Act = new TextBox();
            Txt_ID_Act = new TextBox();
            Lbl_Name_Act = new Label();
            Lbl_Des_Act = new Label();
            Lbl_ID_Act = new Label();
            ...
            Pnl_CRUD_Add_Act.Margin = new Padding(3, 4, 3, 4);
            Pnl_CRUD_Add_Act.Name = "Pnl_CRUD_Add_Act";
            Pnl_CRUD_Add_Act.Size = new Size(536, 581);
            ...
            Btn_Cancelar_Act1.Size = new Size(114, 40);
            ...
            Btn_Asignar_Act1.Size = new Size(114, 40);
            ...
            // Pnl_Add
            // 
            Pnl_Add.Controls.Add(Txt_Desc_Act);
            Pnl_Add.Controls.Add(Txt_Name_Act);
            Pnl_Add.Controls.Add(Txt_ID_Act);
            Pnl_Add.Controls.Add(Lbl_Name_Act);
            Pnl_Add.Controls.Add(Lbl_Des_Act);
            Pnl_Add.Controls.Add(Lbl_ID_Act);
            Pnl_Add.Dock = DockStyle.Top;
            Pnl_Add.Location = new Point(0, 0);
            Pnl_Add.Margin = new Padding(3, 4, 3, 4);
            Pnl_Add.Name = "Pnl_Add";
            Pnl_Add.Size = new Size(536, 500);
            Pnl_Add.TabIndex = 0;
            // 
            // Txt_Desc_Act
            // 
            Txt_Desc_Act.Font = new Font("Segoe UI", 11F);
            Txt_Desc_Act.Location = new Point(34, 200);
            Txt_Desc_Act.Margin = new Padding(3, 4, 3, 4);
            Txt_Desc_Act.Multiline = true;
            Txt_Desc_Act.Name = "Txt_Desc_Act";
            Txt_Desc_Act.Size = new Size(462, 265);
            Txt_Desc_Act.TabIndex = 18;
            // 
            // Txt_Name_Act
            // 
            Txt_Name_Act.Font = new Font("Segoe UI", 11F);
            Txt_Name_Act.Location = new Point(274, 87);
            Txt_Name_Act.Margin = new Padding(3, 4, 3, 4);
            Txt_Name_Act.Name = "Txt_Name_Act";
            Txt_Name_Act.Size = new Size(222, 32);
            Txt_Name_Act.TabIndex = 16;
            // 
            // Txt_ID_Act
            // 
            Txt_ID_Act.Enabled = false;
            Txt_ID_Act.Font = new Font("Segoe UI", 11F);
            Txt_ID_Act.Location = new Point(274, 27);
            Txt_ID_Act.Margin = new Padding(3, 4, 3, 4);
            Txt_ID_Act.Name = "Txt_ID_Act";
            Txt_ID_Act.ReadOnly = true;
            Txt_ID_Act.Size = new Size(222, 32);
            Txt_ID_Act.TabIndex = 8;
            // 
            // Lbl_Name_Act
            // 
            Lbl_Name_Act.AutoSize = true;
            Lbl_Name_Act.Font = new Font("Segoe UI", 11F);
            Lbl_Name_Act.Location = new Point(34, 93);
            Lbl_Name_Act.Name = "Lbl_Name_Act";
            Lbl_Name_Act.Size = new Size(214, 25);
            Lbl_Name_Act.TabIndex = 7;
            Lbl_Name_Act.Text = "Nombre de la Actividad:";
            // 
            // Lbl_Des_Act
            // 
            Lbl_Des_Act.AutoSize = true;
            Lbl_Des_Act.Font = new Font("Segoe UI", 11F);
            Lbl_Des_Act.Location = new Point(34, 153);
            Lbl_Des_Act.Name = "Lbl_Des_Act";
            Lbl_Des_Act.Size = new Size(244, 25);
            Lbl_Des_Act.TabIndex = 6;
            Lbl_Des_Act.Text = "Descripción de la Actividad:";
            // 
            // Lbl_ID_Act
            // 
            Lbl_ID_Act.AutoSize = true;
            Lbl_ID_Act.Font = new Font("Segoe UI", 11F);
            Lbl_ID_Act.Location = new Point(34, 33);
            Lbl_ID_Act.Name = "Lbl_ID_Act";
            Lbl_ID_Act.Size = new Size(163, 25);
            Lbl_ID_Act.TabIndex = 0;
            Lbl_ID_Act.Text = "ID de la Actividad:";
            // 
            // V_CRUD_Add_Act
            // 
        ...
        private TextBox Txt_Name_Act;
        private TextBox Txt_ID_Act;
        private Label Lbl_Name_Act;
        private Label Lbl_Des_Act;
        private Label Lbl_ID_Act;
        private Button Btn_Cancelar_Act1;
        private Button Btn_Asignar_Act1;
        private TextBox Txt_Desc_Act;
    }
}